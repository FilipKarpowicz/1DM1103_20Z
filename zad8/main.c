...
int main(int argc, char **argv)
{
    ...
    if (strcmp("sort", argv[2]) == 0)
    {
        ...
        {
            if (strcmp("name", argv[4]) == 0)
            {
                if (strcmp("descending", argv[5]) == 0)
                {
                    funkcja_p(baza_sbj, 1);
                }
                else if (strcmp("ascending", argv[5]) == 0)
                {
                    funkcja_p(baza_sbj, 0);
                }
            }
            else if (strcmp("id", argv[4]) == 0)
            {
                if (strcmp("descending", argv[5]) == 0)
                {
                    funkcja_o(baza_sbj, 1);
                }
                else if (strcmp("ascending", argv[5]) == 0)
                {
                    funkcja_o(baza_sbj, 0);
                }
            }
        }
    }
    else if (strcmp("list_grades_by_student", argv[2]) == 0)
    {
        list_grades_by_student(baza_ocen, argv[3]);
    }
    else if (strcmp("grades_by_course", argv[2]) == 0)
    {
        list_by_course(baza_ocen, argv[3]);
    }

    // funkcja_p(baza_sbj, 0);
    //list_grades_by_student(baza_ocen, "000007");
    //funkcja_p(baza_sbj, 0);
    //funkcja_o(baza_sbj, 0);
    //list_by_course(baza_ocen, "1DA1245");
    zwolnij_O(baza_ocen);
    zwolnij_P(baza_sbj);
    //zwolnij(baza_stud);
    //fclose(fout);
